...
* This initial page gives a broad overview of whether or not there will be enough new journeypersons and apprentices to meet demand.
...
### Are we producing enough journeypersons to meet demand?

* Supply of Journeypersons is the forecast of apprentice completions.
* Demand for journeypersons is assumed to be twice LMO replacement demand plus 1/3 of LMO expansion demand.
* Regarding replacement demand, we assume that for every retirement or death there is another journeyperson that leaves the trade prematurely.
* Regarding expansion demand, the desired ratio of journeyperson to apprentice is 1:2.
...
plt <- completions_vs_demand|>
  ...
  geom_line()+
  scale_x_continuous(breaks=seq(2022,2034,2))+
...
* The demand for apprentices is assumed to be twice that of new journeypersons: the desired ratio is 2:1.
* Note that there is a many-to-one relationship between trades and occupations. 
